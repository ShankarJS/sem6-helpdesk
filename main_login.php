...
<html lang="en">
	...
	<body>
		<div id="main">		
			...
			<div style="color:#fff;font-family:robob;font-size:1.2em;float:left;margin-top:250px;text-shadow:0px 0px 10px black;"> Welcome to summon helpdesk system.<br /> Here you can ask any query and get a solution.</div>
			<script>
