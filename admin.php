...
<html lang="eng">
	...
	<div>
		<div id="add_student">
			...
			<br><br>
				<input type="tel" name="mob_no" id="mob_number" placeholder="Mobile No." required="required" maxlength="10" minlength="10">
			<br><br>
	...
	<div style="font-family:robob;font-size:1.7em;margin-right:30px;float:left;z-index:5;"> Student Registration Here<br>Complete Administrator Access</div>
	</body>
</html>